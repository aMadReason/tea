...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"dist/behaviours/describe.js":[function(require,module,exports) {
"use strict";
...
var describe = {
  ...
  methods: {
    describe: function describe(ins) {
      var cmd = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
...
},{}],"dist/behaviours/examine.js":[function(require,module,exports) {
"use strict";
...
var _default = examine;
exports.default = _default;
},{}],"dist/behaviours/help.js":[function(require,module,exports) {
"use strict";
...
var behaviour = {
  ...
  methods: {
    help: function help(ins) {
      var cmd = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
      var allowedActs = ins.getProp("filterActionsTo");
      var first = "The ".concat(ins.name, " has the following actions available;");

      var acts = _toConsumableArray(ins.getActionKeys());

      if (allowedActs && Array.isArray(allowedActs) && allowedActs.length > 0) {
        acts = acts.filter(function (i) {
          return allowedActs.indexOf(i) > -1;
        });
      }

      if (acts.length === 0 || !acts) return "".concat(ins.name, " has no actions available");
      if (acts.length === 1) return "".concat(first, " ").concat(acts.join(", "));
      var last = acts.pop();
      return "".concat(first, " ").concat(acts.join(", "), " and ").concat(last, ".");
    }
  },
  actions: {
    help: "help",
...
var _default = behaviour;
exports.default = _default;
},{}],"dist/behaviours/goTo.js":[function(require,module,exports) {
"use strict";
...
var behaviour = {
  ...
  properties: {},
  methods: {
    goTo: function goTo(ins) {
      var cmd = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
      ins.game.setLocationByKey(ins.key);
      return "Moved to ".concat(ins.name, ".");
    }
  },
  actions: {
    go: "goTo",
...
var _default = behaviour;
exports.default = _default;
},{}],"dist/behaviours/take.js":[function(require,module,exports) {
"use strict";
...
var behaviour = {
  ...
  methods: {
    ...
    takeComplex: function takeComplex(ins) {
      var cmd = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
      var noun = ins.noun,
          described = ins.described;
      var otherNoun = cmd.nouns.find(function (i) {
        return i !== noun;
      });
      var otherDesc = cmd.described.find(function (i) {
        return i !== described;
      });
      var inside = ins.game.getThingsByInsideKey(ins.key);
      var targets = ins.game.getThingsByNoun(otherNoun, otherDesc, inside);
      var target = targets[0];

      if (target) {
        target.setInsideKey(ins.game.playerKey);
        return ins.game.capitalise("The ".concat(target.name, " was moved to inventory."));
      }

      return ins.game.capitalise("There is no ".concat(target.name, " in the ").concat(ins.name, "."));
    },
    takeSimple: function takeSimple(ins) {
      var cmd = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
      var key = ins.insideKey;
      var playerKey = ins.game.playerKey;
      if (key === playerKey) return "".concat(ins.name, " is already in your inventory.");
      ...
      return "".concat(ins.name, " added to inventory.").replace(/^\w/, function (c) {
...
var _default = behaviour;
exports.default = _default;
},{}],"dist/behaviours/drop.js":[function(require,module,exports) {
"use strict";
...
var behaviour = {
  ...
  methods: {
    ...
    dropComplex: function dropComplex(ins) {
      var cmd = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
      var verb = cmd.verb;
      var noun = ins.noun,
          described = ins.described;
      ...
      var inside = ins.game.getThingsByInsideKey(ins.game.getPlayerKey());
      var targets = ins.game.getThingsByNoun(otherNoun, otherDesc, inside);
      var target = targets[0];

      if (ins && target && target.insideKey === ins.key) {
        return "".concat(target.name, " is already in the ").concat(ins.name, ".");
      }

      if (ins && target && target.insideKey !== ins.key) {
        target.setInsideKey(ins.key);
        return ins.game.capitalise("The ".concat(target.name, " was left in the ").concat(ins.name, "."));
      }

      if (!target) {
        return "There is no ".concat(otherDesc || otherNoun, " in the inventory to leave in the ").concat(ins.name, ".");
      }

      return "Unable to ".concat(cmd.verb, " the ").concat(otherDesc || otherNoun, ".");
    },
    dropSimple: function dropSimple(ins) {
      var cmd = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
      var playerKey = ins.game.playerKey;
      var key = ins.insideKey;
      var loc = ins.game.getActiveLocation();
      if (key !== playerKey) return "".concat(ins.name, " is not in your inventory.");
      ...
      return "".concat(ins.name, " removed from inventory.").replace(/^\w/, function (c) {
        return c.toUpperCase();
      });
    }
  },
...
var _default = behaviour;
exports.default = _default;
},{}],"dist/behaviours/usePortal.js":[function(require,module,exports) {
"use strict";
...
var behaviour = {
  ...
  methods: {
    use: function use(ins) {
      ...
      return "Moved to ".concat(location.name, ".");
    }
  },
  actions: {
    use: "use"
...
var _default = behaviour;
exports.default = _default;
},{}],"dist/behaviours/lookInside.js":[function(require,module,exports) {
"use strict";
...
var examine = {
  ...
  methods: {
    lookInside: function lookInside(ins) {
      var cmd = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
      var join = cmd.joins[0] || "inside";
      var inside = ["inside", "in", "within"].indexOf(join) > -1;
      if (!inside) return "There is nothing ".concat(join, " the ").concat(ins.name, ".");
      var things = ins.game.getThingsByInsideKey(ins.key).map(function (i) {
        return i.name;
      });

      if (Array.isArray(things) && things.length === 0) {
        return "There is nothing ".concat(join, " the ").concat(ins.name, ".");
      }

      if (things.length === 1) return "There is a ".concat(things.join(", "), " ").concat(join, " the ").concat(ins.name, ".");
      var last = things.pop();
      return "There is a ".concat(things.join(", a "), " and  a ").concat(last, " ").concat(join, " the ").concat(ins.name, ".");
    }
  },
  actions: {
    look: "lookInside"
...
var _default = examine;
exports.default = _default;
},{}],"dist/behaviours/converse.js":[function(require,module,exports) {
"use strict";
...
var converse = {
  ...
  properties: {
    conversationResponses: [{
      verbs: ["answer", "say", "ask", "show", "tell"],
      response: "{name}: ..."
    }]
  },
  methods: {
    converse: function converse(ins) {
      var cmd = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
      var name = ins.game.capitalise(ins.name);
      var verb = cmd.verb,
          input = cmd.input;
      var responses = ins.getProp("conversationResponses");
      var resObj = responses.find(function (r) {
        return r.verbs.includes(verb) && input.includes(r.subject);
      });
      resObj = resObj ? resObj : responses.find(function (r) {
        return r.verbs.includes(verb) && !r.subject;
      });
      var conditionsMet = true;
      var _resObj = resObj,
          _resObj$conditions = _resObj.conditions,
          conditions = _resObj$conditions === void 0 ? [] : _resObj$conditions,
          _resObj$response = _resObj.response,
          response = _resObj$response === void 0 ? "" : _resObj$response;
      conditions.map(function (c) {
        ...
        var propVal = ins.getProp(prop);
        var met = isMet(propVal, operator, value);
...
var _default = converse;
exports.default = _default;
},{}],"dist/behaviours/index.js":[function(require,module,exports) {
"use strict";
...
Object.defineProperty(exports, "examine", {
  enumerable: true,
  get: function () {
    return _examine.default;
  }
});
...
Object.defineProperty(exports, "lookInside", {
  enumerable: true,
  get: function () {
    return _lookInside.default;
  }
});
Object.defineProperty(exports, "converse", {
  enumerable: true,
  get: function () {
    return _converse.default;
  }
});

var _describe = _interopRequireDefault(require("./describe"));

var _examine = _interopRequireDefault(require("./examine"));

var _help = _interopRequireDefault(require("./help"));

var _goTo = _interopRequireDefault(require("./goTo"));
...
var _lookInside = _interopRequireDefault(require("./lookInside"));

var _converse = _interopRequireDefault(require("./converse"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./describe":"dist/behaviours/describe.js","./examine":"dist/behaviours/examine.js","./help":"dist/behaviours/help.js","./goTo":"dist/behaviours/goTo.js","./take":"dist/behaviours/take.js","./drop":"dist/behaviours/drop.js","./usePortal":"dist/behaviours/usePortal.js","./lookInside":"dist/behaviours/lookInside.js","./converse":"dist/behaviours/converse.js"}],"dist/gameCommands/locations.js":[function(require,module,exports) {
"use strict";
...
var gameCommand = {
  name: "locations",
  method: function method(g) {
    var cmd = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
    var first = "Locations available:";

    var locs = _toConsumableArray(g.getLocationNouns());

    if (Array.isArray(locs) && locs.length === 0) return "No locations available";
    if (locs.length === 1) return "".concat(first, " ").concat(locs.join(", "));
    var last = locs.pop();
    return "".concat(first, " ").concat(locs.join(", "), " and ").concat(last, ".");
  }
};
Object.freeze(gameCommand);
var _default = gameCommand;
exports.default = _default;
},{}],"dist/gameCommands/location.js":[function(require,module,exports) {
"use strict";
...
var gameCommand = {
  ...
  method: function method(g) {
    var cmd = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
    var loc = g.getActiveLocation();
    return "The current location is the ".concat(loc.name, ".");
  }
};
Object.freeze(gameCommand);
var _default = gameCommand;
exports.default = _default;
},{}],"dist/gameCommands/index.js":[function(require,module,exports) {
"use strict";
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./locations":"dist/gameCommands/locations.js","./location":"dist/gameCommands/location.js"}],"dist/modules/pubsub.js":[function(require,module,exports) {
"use strict";
...
function pubsub() {
  return {
    ...
    publish: function publish(event, data) {
      ...
      this.subs[event].forEach(function (subCallback) {
        subCallback(Object.assign({
          subEvent: event
        }, data));
      });
    },
    subscribe: function subscribe(event, callback) {
      ...
      return {
        unsubscribe: function unsubscribe() {
          return _this.subs[event].splice(index, 1);
        }
      };
    }
  };
}
},{}],"node_modules/compromise/builds/compromise.mjs":[function(require,module,exports) {
"use strict";
...
var _default = src;
exports.default = _default;
},{}],"dist/modules/commandParser.js":[function(require,module,exports) {
"use strict";
...
var types = ["#ParserComplexImplicit", "#ParserComplex", "#ParserSimple"];
var defaultPatterns = {
  golden: "Adjective",
  "(it)": "Ignore",
  "(light|mix|note|cup)$": "Noun",
  "^(light|mix|move|shift|pick|open)": "Verb",
  "(#Conjunction|above|adjacent|beside|under|over|above|on|over|in|inside|within|behind|undeneath)": "Join",
...
function commandParser(original) {
  var patterns = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var words = Object.assign(Object.assign({}, defaultPatterns), patterns);
  var originalNoStop = original.toLowerCase().replace(/\.+$/, "");
  var doc = (0, _compromise.default)(originalNoStop, words).clone().normalize(normalizeRules);
  Object.keys(words).map(function (p) {
    return doc.match(p).tag(words[p]);
  });
  var type = types.find(function (i) {
    return doc.has(i) && i;
  });
  var tags = doc.out("tags");
  var terms = doc.terms().out("array");
  var verbs = doc.verbs().toInfinitive().out("array");
  var nouns = doc.not("#Ignore").match("#Noun").out("array");
  var described = doc.not("#Direction").not("#Join").match("#Adjective+ #Noun").out("array");
  var joins = doc.match("#Join").out("array");
  var singulars = doc.nouns().toSingular().out("array");
  var adjectives = doc.not("#Direction").match("#Adjective").out("array");
  ...
  if (type === types[0] && nouns.length > 0) {
    adjectives.map(function (a) {
      ...
      if (described.includes(describedAd)) return undefined;
      return described = [describedAd].concat(_toConsumableArray(described));
    });
  }

  var input = originalNoStop.toLowerCase();
  var strictCommand = [verbs[0], described[0] || singulars[0], joins[0] || null, described[1] || singulars[1] || ""].filter(function (i) {
    return i;
  }).join(" ");
  return {
    terms: terms,
...
},{"compromise":"node_modules/compromise/builds/compromise.mjs"}],"dist/Game.js":[function(require,module,exports) {
"use strict";
...
var _commandParser = _interopRequireDefault(require("./modules/commandParser"));
...
var gCommands = [_index.locations, _index.location];
...
function () {
  function Game() {
    ...
    this.pubsub = (0, _pubsub.pubsub)();

    _index.defaultBehaviours.map(function (b) {
      return _this.registerBehaviour(b);
    });

    gCommands.map(function (i) {
      return _this.gameCommands.set(i.name, i.method);
    });
  }
  ...
  _createClass(Game, [{
    ...
    key: "registerBehaviour",
    value: function registerBehaviour(behaviour) {
      var _this2 = this;

      if (Array.isArray(behaviour)) {
        behaviour.map(function (i) {
          return _this2.behaviourReg.set(i.name, i);
        });
      } else {
    ...
    value: function subscribe(eventName, callback) {
      return this.pubsub.subscribe(eventName, function (data) {
        return callback(data);
      });
    }
  }, {
    key: "addLocation",
    value: function addLocation(thing) {
      this.locations.push(thing);
      return this;
    }
  }, {
    key: "addCharacter",
    value: function addCharacter(thing) {
    ...
    value: function getActiveLocation() {
      ...
      return this.locations.find(function (i) {
        return i.key === _this4.locationKey;
      });
    }
  }, {
    key: "getLocationByKey",
    value: function getLocationByKey() {
    ...
    key: "setPlayerKey",
    value: function setPlayerKey(key) {
      this.playerKey = key;
      return this;
    }
  }, {
    key: "setLocationByKey",
    value: function setLocationByKey(key) {
      var player = this.getActivePlayer();
      var from = this.getLocationByKey(this.locationKey);
      ...
      if (to && to.key !== from.key) {
        ...
        return this.pubsub.publish(events.locationChange, {
          from: from,
          to: to
        });
      }
    ...
    value: function getLocations() {
      return _toConsumableArray(this.locations);
    }
  }, {
    key: "getThingsByInsideKey",
    value: function getThingsByInsideKey(key) {
      var things = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.things;
      return things.filter(function (i) {
        return i.insideKey === key;
      });
    }
  }, {
    key: "getLocationNouns",
    value: function getLocationNouns() {
      return this.locations.map(function (l) {
        return l.noun;
      });
    }
  }, {
    key: "getAllActiveThings",
    value: function getAllActiveThings() {
      var locationKey = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.locationKey;
      var playerKey = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.playerKey;
      return [].concat(_toConsumableArray(this.getThingsByInsideKey(locationKey)), _toConsumableArray(this.getThingsByInsideKey(playerKey)), _toConsumableArray(this.getThingsByInsideKey(locationKey, this.getCharacters())));
    }
  }, {
    key: "getThingByKey",
    value: function getThingByKey(key) {
      var things = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.things;
      return things.find(function (i) {
        return i.key === key;
      });
    }
  }, {
    ...
    key: "getThingsByNoun",
    value: function getThingsByNoun(noun) {
      var described = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : undefined;
      var things = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : this.getAllActiveThings();
      var fThings = things.filter(function (t) {
        var isDescribed = described && t.described === described;
    ...
    key: "resolveGameData",
    value: function resolveGameData(data) {
      var _this5 = this;

      var locations = data.locations,
          things = data.things,
          characters = data.characters,
          _data$playerKey = data.playerKey,
          playerKey = _data$playerKey === void 0 ? null : _data$playerKey;

      if (Array.isArray(locations)) {
        locations.map(function (i) {
          var loc = _index.ThingMaker.make(i, _this5.behaviourReg, _this5);

          return _this5.addLocation(loc);
        });
      }

      if (Array.isArray(things)) {
        things.map(function (i) {
          var thing = _index.ThingMaker.make(i, _this5.behaviourReg, _this5);

          return _this5.addThing(thing);
        });
      }

      if (Array.isArray(characters)) {
        characters.map(function (i) {
          var char = _index.ThingMaker.make(i, _this5.behaviourReg, _this5);

          return _this5.addCharacter(char);
        });
      }

      if (playerKey && characters.find(function (i) {
        return i.key === playerKey;
      })) {
        this.setPlayerKey(playerKey);
      } else {
        var player = _index.ThingMaker.make({
          key: "__default__",
          noun: "player"
    ...
    key: "parseCommand",
    value: function parseCommand(cmd) {
      var patterns = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.parserPatterns;
      var msg = [];
      var parserResult = (0, _commandParser.default)(cmd.toLocaleLowerCase(), patterns);
      var nouns = parserResult.nouns,
          verbs = parserResult.verbs,
          described = parserResult.described,
          input = parserResult.input,
          terms = parserResult.terms;
      var verb = verbs[0];
      var locations = this.getThingsByNoun(nouns[0], described[0], this.getLocations());
      var firstThings = this.getThingsByNoun(nouns[0], described[0]);
      var secondThings = this.getThingsByNoun(nouns[1], described[1] || described[0]);
      var tLength = terms.length;
      ...
      type = Object.keys(cmdTypes).find(function (k) {
        return cmdTypes[k] && k;
      }) || type;
      var errTypes = {
      ...
      type = Object.keys(errTypes).find(function (k) {
        return errTypes[k] && k;
      }) || type;

      if (type === "simpleNoThing") {
        type = "simpleNoThing";
        msg.push("No \"".concat(nouns[0], "\" found in inventory or ").concat(this.getActiveLocation().name, "."));
      }

      if (type === "simpleBadVerb") {
        type = "simpleBadVerb";
        msg.push("Unknown action, unable to ".concat(input, "."));
      }

      if (type === "simpleDuplicate") {
        type = "simpleDuplicate";
        msg.push("Please be more descriptive and reference ".concat(firstThings.map(function (i) {
          return "\"".concat(i.described, "\"");
        }).join(" or "), "."));
      }
    ...
    value: function command(_command) {
      ...
      var patterns = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.parserPatterns;
      var cmd = this.parseCommand(_command, patterns);
      var verb = cmd.verb,
          type = cmd.type,
          locations = cmd.locations,
          firstThings = cmd.firstThings,
          secondThings = cmd.secondThings,
          described = cmd.described,
          nouns = cmd.nouns,
          msg = cmd.msg,
          input = cmd.input;
      ...
      var response = function response() {
        return "Invalid command: ".concat(input, ".");
      };
      ...
      if (hasMsg) {
        ...
        if (type === "gameCommand") {
          ...
          response = function response() {
            return _this6.gameCommands.get(input)(_this6);
          };
        }
        ...
        if (type === "complex") {
          valid = true;
          var first = firstThings.find(function (i) {
            return described.includes(i.name) || nouns.includes(i.name);
          });
          var second = secondThings.find(function (i) {
            return described.includes(i.name) || nouns.includes(i.name);
          });

          if (firstThings.length > 0 || secondThings.length > 0) {
            var thing = first || second;
            if (thing) response = thing.getAction(verb, cmd);
          }
        }
      }

      var res = Object.assign(Object.assign({}, cmd), {
        valid: valid,
        response: response
      });
...
var _default = Game;
exports.default = _default;
},{"./modules/pubsub":"dist/modules/pubsub.js","./modules/commandParser":"dist/modules/commandParser.js","./index":"dist/index.js"}],"dist/modules/uuid.js":[function(require,module,exports) {
"use strict";
...
exports.genId = exports.uuid = void 0;
...
exports.genId = genId;
},{}],"dist/Thing.js":[function(require,module,exports) {
"use strict";
...
var _uuid = require("./modules/uuid");
...
function () {
  function Thing(_ref) {
    ...
    var _ref$noun = _ref.noun,
        noun = _ref$noun === void 0 ? "" : _ref$noun,
        _ref$described = _ref.described,
        described = _ref$described === void 0 ? "" : _ref$described,
        _ref$insideKey = _ref.insideKey,
        insideKey = _ref$insideKey === void 0 ? "" : _ref$insideKey,
        _ref$properties = _ref.properties,
        properties = _ref$properties === void 0 ? {} : _ref$properties,
        _ref$game = _ref.game,
        game = _ref$game === void 0 ? null : _ref$game,
        _ref$key = _ref.key,
        key = _ref$key === void 0 ? (0, _uuid.genId)() : _ref$key;
    ...
    Object.keys(properties).map(function (k) {
      return _this.setProp(k, properties[k]);
    });
    return this;
  }
  ...
  _createClass(Thing, [{
    key: "setInsideKey",
    value: function setInsideKey(key) {
      this.insideKey = key;
    }
  }, {
    key: "setProp",
    ...
    key: "hasMethod",
    value: function hasMethod(key) {
      return this.methods.has(key);
    }
  }, {
    key: "getMethod",
    value: function getMethod(key) {
      var _this2 = this;

      var cmd = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
      return function () {
        return _this2.methods.get(key)(_this2, cmd);
      };
    }
  }, {
    key: "callMethod",
    value: function callMethod(key) {
      var cmd = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
      var method = this.getMethod(key, cmd);
      return method(this, cmd);
    }
  }, {
    key: "setAction",
    value: function setAction(key, value) {
      this.actions.set(key, value);
    }
  }, {
    key: "hasAction",
    value: function hasAction(key) {
    ...
    key: "getActionKeys",
    value: function getActionKeys() {
      return _toConsumableArray(this.actions.keys());
    }
  }, {
    key: "addBehaviour",
    value: function addBehaviour(behaviour) {
      ...
      var properties = behaviour.properties,
          methods = behaviour.methods,
          actions = behaviour.actions;

      if (properties) {
        Object.keys(properties).map(function (p) {
          var prop = _this3.getProp(p);

          if (!prop) _this3.setProp(p, properties[p]);
          if (prop && _typeof(prop) === "object") _this3.setProp(p, Object.assign(Object.assign({}, properties[p]), prop));
          if (prop && Array.isArray(prop)) _this3.setProp(p, [].concat(_toConsumableArray(properties[p]), _toConsumableArray(prop)));
          return null;
        });
      }
      ...
      if (methods) {
        Object.keys(methods).map(function (m) {
          return _this3.setMethod(m, methods[m]);
        });
      }

      if (actions) {
        Object.keys(actions).map(function (a) {
          return _this3.setAction(a, actions[a]);
        });
      }
...
var _default = Thing;
exports.default = _default;
},{"./modules/uuid":"dist/modules/uuid.js"}],"dist/ThingMaker.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = exports.defaultBehaviours = void 0;

var _index = require("./index");

var _index2 = require("./behaviours/index");
...
var defaultBehaviours = [_index2.describe, _index2.help, _index2.examine];
...
function () {
  function ThingMaker() {
    _classCallCheck(this, ThingMaker);
  }

  _createClass(ThingMaker, null, [{
    key: "preProcess",
    value: function preProcess(data) {
      var defaultBehaviors = defaultBehaviours.map(function (i) {
        return i.name;
      });
      var dataBehaviours = data.behaviours || [];

      var behaviours = _toConsumableArray(new Set([].concat(_toConsumableArray(defaultBehaviors), _toConsumableArray(dataBehaviours))));

      var processedData = Object.assign(Object.assign({}, data), {
    ...
    key: "make",
    value: function make(data, behaviourReg, game) {
      var processedData = ThingMaker.preProcess(data);
      var noun = processedData.noun,
          described = processedData.described,
          behaviours = processedData.behaviours,
          insideKey = processedData.insideKey,
          key = processedData.key,
          properties = processedData.properties,
          actions = processedData.actions;
      var thing = new _index.Thing({
        noun: noun,
      ...
      if (actions) {
        Object.keys(actions).map(function (k) {
          return thing.setAction(k, actions[k]);
        });
      }
...
var _default = ThingMaker;
exports.default = _default;
},{"./index":"dist/index.js","./behaviours/index":"dist/behaviours/index.js"}],"dist/index.js":[function(require,module,exports) {
"use strict";
...
Object.defineProperty(exports, "ThingMaker", {
  enumerable: true,
  get: function () {
    return _ThingMaker.default;
  }
});
Object.defineProperty(exports, "defaultBehaviours", {
  enumerable: true,
  get: function () {
    return _ThingMaker.defaultBehaviours;
  }
});

var _behaviours = require("./behaviours");

Object.keys(_behaviours).forEach(function (key) {
...
var _gameCommands = require("./gameCommands");

Object.keys(_gameCommands).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (Object.prototype.hasOwnProperty.call(_exportNames, key)) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _gameCommands[key];
    }
  });
});
...
var _Thing = _interopRequireDefault(require("./Thing"));

var _ThingMaker = _interopRequireWildcard(require("./ThingMaker"));
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./behaviours":"dist/behaviours/index.js","./gameCommands":"dist/gameCommands/index.js","./Game":"dist/Game.js","./Thing":"dist/Thing.js","./ThingMaker":"dist/ThingMaker.js"}],"tests/gamedata.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.gamedata = exports.testThing = void 0;
var testThing = {
  noun: "cup",
  insideKey: null,
...
var gamedata = {
  ...
  locations: [{
    ...
    properties: {
      descriptions: {
        default: "Waves slap rythmically against the hull of the boat as the water rolls in time of the waves. The deck is sparse."
      }
    }
  }]
};
exports.gamedata = gamedata;
},{}],"webcomponents/demo.js":[function(require,module,exports) {
"use strict";

var _index = require("../dist/index");

var _gamedata = require("../tests/gamedata");

(function () {
  var G = new _index.Game();
  G.addPatterns({
    golden: "Adjective",
    note: "Noun",
    me: "Ignore"
  });
  G.registerBehaviour([_index.goTo, _index.take, _index.drop, _index.converse, _index.lookInside, _index.usePortal]);
  G.resolveGameData(_gamedata.gamedata);
  var gameEl = document.querySelector("tea-game-el");
  gameEl.setGame(G);
  console.log(gameEl);
})();
},{"../dist/index":"dist/index.js","../tests/gamedata":"tests/gamedata.js"}],"C:/Users/Amanda/AppData/Roaming/npm/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/Amanda/AppData/Roaming/npm/node_modules/parcel/src/builtins/hmr-runtime.js","webcomponents/demo.js"], null)
//# sourceMappingURL=/demo.84c3466d.js.map